...
public class ImportItemSearchRule
{
    ...
    GoodsImportGoodsInfo gif;

    public ImportItemSearchRule()
    {
	...
	public GoodsImportGoodsInfo getGif() {
		return gif;
	}

	public void setGif(GoodsImportGoodsInfo gif) {
		this.gif = gif;
	}
