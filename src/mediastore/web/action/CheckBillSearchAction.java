...
public class CheckBillSearchAction extends AbstractAction
{

    public CheckBillSearchAction()
    {
    }
    ...
    public ActionForward execute(ActionContext actionContext)
    {
    	try
    	{
	    	String orderby = oConvert.getString(actionContext.getParameter("orderby"),"checkTime desc");
	    	CheckBillForm gif=(CheckBillForm)actionContext.getForm();
			if(gif==null)
				gif=new CheckBillForm();
	        ...
	        ResultsetList ibsri = giinfo.getBillListByRule(gif,importTime1,importTime2,curpage,orderby);
	        ...
	        return actionContext.getMapping().findForward("CheckBillSearch");
    	}
    	catch(Exception e)
        {
