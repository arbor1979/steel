...
public class MoneyFlowSearchAction extends AbstractAction
{

    public MoneyFlowSearchAction()
    {
    }
    ...
    public ActionForward execute(ActionContext actionContext)
    {
    	try
		{
	    	...
	    	flowList=cw.getMoneyFlowList(importTime1, importTime2,deptid);
	        ...
	        return actionContext.getMapping().findForward("MoneyFlowSearch");
		}
    	catch(Exception e)
		{
