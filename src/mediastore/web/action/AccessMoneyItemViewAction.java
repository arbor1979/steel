...
public class AccessMoneyItemViewAction extends AbstractAction
{

    public AccessMoneyItemViewAction()
    {
    }
    ...
    public ActionForward execute(ActionContext actionContext)
    {
    	try
    	{
	    	...
	    	List ibf=fyi.getZhuanKuanById(billId,deptid);
			actionContext.getRequest().setAttribute("billInfo", ibf);
			actionContext.getRequest().setAttribute("ifprint",ifprint);
			return actionContext.getMapping().findForward("AccessMoneyItemView");
    	}
    	catch(Exception e)
        {
