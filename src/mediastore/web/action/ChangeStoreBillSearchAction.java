...
public class ChangeStoreBillSearchAction extends AbstractAction
{

    public ChangeStoreBillSearchAction()
    {
    }
    ...
    public ActionForward execute(ActionContext actionContext)
    {
    	try
    	{
	    	...
	    	ChangeStoreBillForm gif=(ChangeStoreBillForm)actionContext.getForm();
			if(gif==null)
				gif=new ChangeStoreBillForm();
	        ...
	        ResultsetList ibsri = geinfo.getBillListByRule(gif,importTime1,importTime2,curpage,orderby);
	        List billIdList = geinfo.getBillIdList(ctx.getDeptid());
	        List PersonList = geinfo.getPersonsList(ctx.getDeptid());
	        ...
	        return actionContext.getMapping().findForward("ChangeStoreBillSearch");
    	}
    	catch(Exception e)
        {
