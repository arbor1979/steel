...
<tr>
	...
	<table width="100%" align="center" bordercolor="#000000" border=1 cellpadding="5" cellspacing="0" style="border-collapse:collapse">
		...
		<tr bgcolor="#ffffff" >
			...
			<td align='right'><%= nf.format(tmpInfo.getImportUnitPrice())%></td>
...
<%}else{ %>
<p align="center"><input type="button" name="printtr" value=" 打印 " onclick="window.navigate('importItemsView.do?billId=<%=ibf.getBillId() %>&deptid=<%=ibf.getDeptid() %>&ifprint=2');">
