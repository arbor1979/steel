...
<%}else{ %>
<p align="center"><input type="button" name="printtr" value=" 打印 " onclick="window.navigate('otherPayItemView.do?billId=<%=ibf.getBillid() %>&deptid=<%=ibf.getDeptid() %>&ifprint=2');">
