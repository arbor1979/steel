...
%>
<br>
<h2 align="center" style="font-family: 楷体_GB2312;"><%=ibf.getShortname() %>【<%=skind %>单】</h2>
<table width="100%" align="cneter">
<tr >
	<td >单号：<b><%=ibf.getBillId() %></b></td>
	<td align=right>录单时间：<%=ibf.getCheckTime()%></td>
</tr>
	...
	<table width="100%" align="center" bordercolor="#000000" border=1 cellpadding="5" cellspacing="0" style="border-collapse:collapse">
		...
		<tr bgcolor="#ffffff">
			...
			<td align="center" width=60><b>账面数(吨)</b></td>
			<td align="center" width=60><b>实盘数(吨)</b></td>
			<td align="center" width=60><b><%=skind %>数(吨)</b></td>
			<td align="center"><b><%=skind %>数</b></td>
...
<%}else{ %>
<p align="center"><input type="button" name="printtr" value=" 打印 " onclick="window.navigate('checkItemsView.do?billId=<%=ibf.getBillId() %>&deptid=<%=ibf.getDeptid() %>&ifprint=2');">
